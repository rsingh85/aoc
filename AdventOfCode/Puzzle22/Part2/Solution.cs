...
namespace AdventOfCode.Puzzle22.Part2
{
    public class Solution : ISolution
    {
        private List<int> _playerOneInitialDeck = new List<int>();
        private List<int> _playerTwoInitialDeck = new List<int>();

        public void Run()
        {
            ParseInput(File.ReadAllLines(@"Puzzle22\Part2\Input.txt"));
